...
const Login = ({openSignUp}) => {
  return (
    <div>
      <h2 className='text-2xl font-boldmb-4'>Login</h2>
      <form >
        <div className='mb-4'>
        ...
        <div className='mb-4'>
            ...
            <input type="password" className='w-full px-3 py-2 border' placeholder='Enter Passeword'/>
        </div>
      ...
      <div className='text-center'>
        ...
        <button className='text-red-800 ml-4' onClick={openSignUp}>Sign Up</button>
      </div>
    </div>
  )
}
