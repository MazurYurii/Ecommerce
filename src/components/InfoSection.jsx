...
const InfoSection = () => {
    const infoItems = [
        ...
        },
        {
            ...
            description: 'Your payment information is safewith us',
        },
        {
    ...
    <div className='bg-white pb-8 pt-12'>
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4'>
        {infoItems.map((item, index) => (
            <div key={index} className='flex flex-col items-center text-center p-4 border-rounded-lg shadow-md transform transition-transform duration-500 hover:scale-105 cursor-pointer'>
                {item.icon}
