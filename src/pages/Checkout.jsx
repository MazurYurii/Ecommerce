...
const Checkout = ({setOrder}) => {
    ...
    const [shippingToggle, setShippingTogle] = useState(true);
    ...
    <div className='container mx-auto py-8 min-h-96 px-4 md:px-16 lg:px-24'>
      ...
      <div className='flex flex-col md:flex-row justify-between space-x-10 mt-8'>
        <div className='md:w-2/3'>
            ...
            <div className='border p-2 mb-6'>
                <div className='flex items-center justify-between'
                onClick={() => setShippingTogle(!shippingToggle)}>
        ...
        <div className='md:w-1/3 bg-white p-6 rounded-lg shadow-md border'>
            <h3 className='text-lg font-semibold mb-4'>Oder Summary</h3>
            ...
            <button className='w-full bg-red-600 text-white py-2 mt-6 hover:bg-red-800' onClick={handleOeder}>Place Order</button>
        </div>
      </div>
    </div>
  )
