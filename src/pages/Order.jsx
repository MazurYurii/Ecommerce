...
const Order = ({order}) => {
  ...
  return (
    ...
    <h2 className='text-2xl font-semiboldmb-4'>Thank you for your order</h2>
      <p>Your order has been placed successfully you will reciev an email confirmation shortly</p>
      <div className='mt-6 p-4 border rounded-lg bg-gray-100'>
        ...
        <div className='mt-6'>
            <button className='bg-green-600 text-white py-2 px-4 hover:bg-green-800 '>Order tracking</button>
