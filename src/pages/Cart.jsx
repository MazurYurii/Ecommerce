  ...
  return (
    <div className='container mx-auto py-8 min-h-96 px-4 md:px-16 lg:px-24'>
      {cart.products.length > 0 ? (
        <div>
            ...
            <div className='flex flex-col md:flex-row justify-between space-x-10 mt-8'>
                    ...
                    {cart.products.map((product) => (
                        <div key={product.id} className='flex items-center justify-between p-3 border-b'>
                            ...
                            <div className='flex space-x-12 items-center'>
                                ...
                                <p>${(product.quantity * product.price).toFixed(0)}</p>
                ...
                <div className='md:w-1/3 bg-white p-6 rounded-lg shadow-md border'>
                    ...
                    <div className='mb-4 border-b border-t pb-2'>
                        <p>Shipping:</p>
                        <p className='ml-2'>shipping to {" "}
                        <span className='taxt-xs font-bold'>{address}</span>
                        </p>
        ...
        <img src={EmptyCart} alt="" className='h-96 m-4'/>
        </div>
        )}
    </div>
  )
